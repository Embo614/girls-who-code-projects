...
print("These people can be government, nations, companies, community, organizations and induviduals.\n")
...
while giveInfo.lower() == "yes":
    ...
    if topic.lower() == "a":
        ...
        print("Sorry, I did't catch that. Choose one of the options listed.")
